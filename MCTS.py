...
class MCTS:
    ...
    def monteCarloND(self):
        ...
        for Label in Labels:
            ...
            obj = JS(dataframe=self.df, all_patterns=Without_duplicates, sita=.5, root=self.root,
                     label=Label, M_value=self.mValue, minimum_covered=1)

            for i in obj.Jaccard_Sim_ND()[0]:
                print(i)
